...
export function ClientsMap({ className }: ClientsMapProps) {
  ...
  return (
    <div
      className={cn(
        'relative rounded-[32px] border border-white/5 bg-[rgba(255,255,255,0.05)] p-10 shadow-sm',
        className
      )}
    >
      ...
      <div className="relative h-[500px] w-full overflow-hidden rounded-[24px] border border-white/5 bg-[#0f1322]">
        <div
          ref={mapRef}
          className="h-full w-full brightness-110 contrast-[0.95] transition-all [&_.ol-zoom]:top-4 [&_.ol-zoom]:right-4 [&_.ol-zoom]:left-auto [&_.ol-zoom]:rounded-lg [&_.ol-zoom]:bg-white/10 [&_.ol-zoom_button]:h-8 [&_.ol-zoom_button]:w-8 [&_.ol-zoom_button]:bg-transparent [&_.ol-zoom_button]:text-xl [&_.ol-zoom_button]:text-white [&_.ol-zoom_button:hover]:bg-white/20 [&_.ol-zoom-in]:rounded-t-lg [&_.ol-zoom-out]:rounded-b-lg"
        ></div>
